...
sre.Engine.Speech.NONE;this.structure=!1;this.ruleSets=[];this.cache=!0;this.markup=sre.Engine.Markup.NONE;this.isEdge=this.isIE=this.strict=!1;this.rate="100";this.setupTests_=[]};goog.addSingletonGetter(sre.Engine);sre.Engine.personalityProps={PITCH:"pitch",RATE:"rate",VOLUME:"volume",PAUSE:"pause",JOIN:"join"};sre.Engine.Mode={SYNC:"sync",ASYNC:"async",HTTP:"http"};sre.Engine.Speech={NONE:"none",SHALLOW:"shallow",DEEP:"deep"};
sre.Engine.Markup={NONE:"none",PUNCTUATION:"punctuation",SSML:"ssml",SSML_STEP:"ssml_step",ACSS:"acss",SABLE:"sable",VOICEXML:"voicexml"};sre.Engine.registerTest=function(a){sre.Engine.getInstance().setupTests_.push(a)};sre.Engine.isReady=function(){return sre.Engine.getInstance().setupTests_.every(function(a){return a()})};sre.Engine.prototype.setupBrowsers=function(){this.isIE=sre.BrowserUtil.detectIE();this.isEdge=sre.BrowserUtil.detectEdge()};sre.Engine.prototype.getAxisValues=function(){return sre.DynamicCstr.getAxisValues()};
sre.Engine.defaultEvaluator=function(a,b){return a};sre.Engine.prototype.getRate=function(){var a=parseInt(this.rate,10);return isNaN(a)?100:a};sre.XpathUtil={};sre.XpathUtil.xpathSupported=function(){return"undefined"==typeof XPathResult?!1:!0};sre.XpathUtil.currentDocument=null;sre.XpathUtil.xpathEvaluate=sre.XpathUtil.xpathSupported()?document.evaluate:sre.SystemExternal.xpath.evaluate;sre.XpathUtil.xpathResult=sre.XpathUtil.xpathSupported()?XPathResult:sre.SystemExternal.xpath.XPathResult;sre.XpathUtil.createNSResolver=sre.XpathUtil.xpathSupported()?document.createNSResolver:sre.SystemExternal.xpath.createNSResolver;
...
sre.XmlRenderer.prototype.markup=function(a){this.setScaleFunction(-2,2,-100,100,2);a=sre.AudioUtil.personalityMarkup(a);for(var b=[],c=[],d=0,e;e=a[d];d++)if(e.span)b.push(this.merge(e.span));else if(sre.AudioUtil.isPauseElement(e))b.push(this.pause(e));else{if(e.close.length)for(var f=0;f<e.close.length;f++){var g=c.pop();if(-1===e.close.indexOf(g))throw Error("Unknown closing markup element: "+g);b.push(this.closeTag(g))}e.open.length&&sre.AudioUtil.sortClose(e.open.slice(),a.slice(d+1)).forEach(goog.bind(function(a){b.push(this.prosodyElement(a,
e[a]));c.push(a)},this))}return b.join(" ")};sre.XmlRenderer.prototype.closeTag=goog.abstractMethod;sre.SableRenderer=function(){sre.XmlRenderer.call(this)};goog.inherits(sre.SableRenderer,sre.XmlRenderer);sre.SableRenderer.prototype.pause=function(a){return'<BREAK MSEC="'+this.pauseValue(a[sre.Engine.personalityProps.PAUSE])+'"/>'};
...
sre.AuralRendering.prototype.finalize=function(a){var b=sre.AuralRendering.rendererMapping_[sre.Engine.getInstance().markup];return b?b.finalize(a):a};sre.AuralRendering.prototype.error=function(a){var b=sre.AuralRendering.rendererMapping_[sre.Engine.getInstance().markup];return b?b.error(a):""};sre.AuralRendering.registerRenderer=function(a,b){sre.AuralRendering.rendererMapping_[a]=b};sre.AuralRendering.rendererMapping_={};sre.AuralRendering.registerRenderer(sre.Engine.Markup.NONE,new sre.StringRenderer);
sre.AuralRendering.registerRenderer(sre.Engine.Markup.PUNCTUATION,new sre.PunctuationRenderer);sre.AuralRendering.registerRenderer(sre.Engine.Markup.ACSS,new sre.AcssRenderer);sre.AuralRendering.registerRenderer(sre.Engine.Markup.SABLE,new sre.SableRenderer);sre.AuralRendering.xmlInstance=new sre.SsmlRenderer;sre.AuralRendering.registerRenderer(sre.Engine.Markup.VOICEXML,sre.AuralRendering.xmlInstance);sre.AuralRendering.registerRenderer(sre.Engine.Markup.SSML,sre.AuralRendering.xmlInstance);
sre.AuralRendering.registerRenderer(sre.Engine.Markup.SSML_STEP,new sre.SsmlStepRenderer);sre.Debugger=function(){this.isActive_=!1;this.outputFunction_=console.info;this.stream_=null};goog.addSingletonGetter(sre.Debugger);sre.Debugger.prototype.init=function(a){a&&this.startDebugFile_(a);this.isActive_=!0};
...
MATRIX:"matrix",VECTOR:"vector",CASES:"cases",TABLE:"table",UNKNOWN:"unknown"};
...
sre.SemanticNode.prototype.querySelectorAll=function(a){for(var b=[],c=0,d;d=this.childNodes[c];c++)b=b.concat(d.querySelectorAll(a));a(this)&&b.unshift(this);return b};
...
sre.SemanticNode.prototype.toString=function(a){var b=new sre.SystemExternal.xmldom.XMLSerializer,c=(new sre.SystemExternal.xmldom.DOMParser).parseFromString("<snode/>","text/xml");return b.serializeToString(this.xml(c,a))};
sre.SemanticNode.prototype.xmlAttributes_=function(a){a.setAttribute("role",this.role);this.font!=sre.SemanticAttr.Font.UNKNOWN&&a.setAttribute("font",this.font);Object.keys(this.annotation).length&&a.setAttribute("annotation",this.xmlAnnotation());this.embellished&&a.setAttribute("embellished",this.embellished);this.fencePointer&&a.setAttribute("fencepointer",this.fencePointer);a.setAttribute("id",this.id);this.addExternalAttributes_(a)};
sre.SemanticNode.prototype.addExternalAttributes_=function(a){for(var b in this.attributes)a.setAttribute(b,this.attributes[b])};sre.SemanticNode.prototype.xmlAnnotation=function(){var a=[],b;for(b in this.annotation)this.annotation[b].forEach(function(c){a.push(b+":"+c)});return a.join(";")};sre.SemanticNode.prototype.updateContent=function(a){var b=a.trim();a=a&&!b?a:b;this.textContent!=a&&(b=sre.SemanticAttr.lookupMeaning(a),this.textContent=a,this.role=b.role,this.type=b.type,this.font=b.font)};
sre.SemanticNode.prototype.addMathmlNodes=function(a){for(var b=0,c;c=a[b];b++)-1==this.mathml.indexOf(c)&&this.mathml.push(c)};sre.SemanticNode.prototype.removeMathmlNodes_=function(a){for(var b=this.mathml,c=0,d;d=a[c];c++)d=b.indexOf(d),-1!=d&&b.splice(d,1);this.mathml=b};sre.SemanticNode.prototype.appendChild=function(a){this.childNodes.push(a);this.addMathmlNodes(a.mathml);a.parent=this};
...
sre.EnrichMathml.setAttributes=function(a,b){a.setAttribute(sre.EnrichMathml.Attribute.TYPE,b.type);a.setAttribute(sre.EnrichMathml.Attribute.ROLE,b.role);Object.keys(b.annotation).length&&a.setAttribute(sre.EnrichMathml.Attribute.ANNOTATION,b.xmlAnnotation());b.font!=sre.Semantic.Font.UNKNOWN&&a.setAttribute(sre.EnrichMathml.Attribute.FONT,b.font);a.setAttribute(sre.EnrichMathml.Attribute.ID,b.id);b.childNodes.length&&a.setAttribute(sre.EnrichMathml.Attribute.CHILDREN,sre.EnrichMathml.makeIdList(b.childNodes));
...
sre.Grammar.parseState=function(a){var b={};a=a.split(" ");for(var c=0,d=a.length;c<d;c++){var e=a[c].split(":"),f=e[1];b[e[0]]=f?f:!0}return b};sre.Grammar.parseInput=function(a){var b={};a=a.split(":");for(var c=0,d=a.length;c<d;c++){var e=a[c].split("="),f=e[0].trim();e[1]?b[f]=e[1].trim():f.match(/^!/)?b[f.slice(1)]=!1:b[f]=!0}return b};
sre.Grammar.correctFont_=function(a,b){if(!b||!a)return a;b=sre.L10n.getLocale().FONT[b]||b;b=b.split(/ |-/);b=new RegExp("^"+b.join("( |-)")+"( |-)");return a.replace(b,"")};sre.Grammar.addAnnotation_=function(a,b){return a+":"+b};sre.Grammar.noTranslateText_=function(a){a.match(new RegExp("^["+sre.Messages.REGEXP.TEXT+"]+$"))&&(sre.Grammar.getInstance().currentFlags.translate=!1);return a};sre.Grammar.getInstance().setCorrection("ignoreFont",sre.Grammar.correctFont_);
sre.Grammar.getInstance().setPreprocessor("annotation",sre.Grammar.addAnnotation_);sre.Grammar.getInstance().setPreprocessor("noTranslateText",sre.Grammar.noTranslateText_);sre.Messages={};sre.Messages.MS={START:"",FRAC_V:"",FRAC_B:"",FRAC_S:"",END:"",FRAC_OVER:"",TWICE:"",NEST_FRAC:"",ENDFRAC:"",SUPER:"",SUB:"",SUP:"",SUPERSCRIPT:"",SUBSCRIPT:"",BASELINE:"",BASE:"",NESTED:"",NEST_ROOT:"",STARTROOT:"",ENDROOT:"",ROOTINDEX:"",ROOT:"",INDEX:"",UNDER:"",UNDERSCRIPT:"",OVER:"",OVERSCRIPT:""};sre.Messages.MS_FUNC={FRAC_NEST_DEPTH:function(a){return!1},RADICAL_NEST_DEPTH:function(a){return""},COMBINE_ROOT_INDEX:function(a,b){return a}};sre.Messages.MS_ROOT_INDEX={};
...
sre.Messages.NAVIGATE={COLLAPSIBLE:"",EXPANDABLE:"",LEVEL:""};sre.Messages.REGEXP={TEXT:"a-zA-Z",NUMBER:"",DECIMAL_MARK:"",DIGIT_GROUP:""};sre.Messages.PLURAL_UNIT={};sre.Messages.PLURAL=function(a){return/.*s$/.test(a)?a:a+"s"};sre.MathspeakUtil={};sre.MathspeakUtil.spaceoutText=function(a){return a.textContent.split("").join(" ")};sre.MathspeakUtil.spaceoutNodes=function(a,b){var c=a.textContent.split(""),d=[],e=sre.SemanticProcessor.getInstance();a=a.ownerDocument;for(var f=0,g;g=c[f];f++)g=e.identifierNode(g,sre.Semantic.Font.UNKNOWN,""),b(g),d.push(g.xml(a));return d};sre.MathspeakUtil.spaceoutNumber=function(a){return sre.MathspeakUtil.spaceoutNodes(a,function(a){a.textContent.match(/\W/)||(a.type=sre.Semantic.Type.NUMBER)})};
...
sre.MathspeakUtil.hundredsToWords=function(a){a%=1E3;var b=sre.MathspeakUtil.onesNumbers[Math.floor(a/100)]?sre.MathspeakUtil.onesNumbers[Math.floor(a/100)]+"-hundred":"";(a%=100)&&(b=b+(b?"-":"")+(sre.MathspeakUtil.onesNumbers[a]||sre.MathspeakUtil.tensNumbers[Math.floor(a/10)]+(a%10?"-"+sre.MathspeakUtil.onesNumbers[a%10]:"")));return b};
sre.MathspeakUtil.numberToWords=function(a){if(a>=Math.pow(10,36))return a.toString();for(var b=0,c="";0<a;)a%1E3&&(c=sre.MathspeakUtil.hundredsToWords(a%1E3)+(b?"-"+sre.MathspeakUtil.largeNumbers[b]+"-":"")+c),a=Math.floor(a/1E3),b++;return c.replace(/-$/,"")};sre.MathspeakUtil.numberToOrdinal=function(a,b){if(1===a)return b?"oneths":"oneth";if(2===a)return b?"halves":"half";a=sre.MathspeakUtil.wordOrdinal(a);return b?a+"s":a};
...
sre.MathspeakUtil.vulgarFraction=function(a,b){b="undefined"===typeof b?"-":b;a=sre.MathspeakUtil.convertVulgarFraction_(a);return a.convertible&&a.enumerator&&a.denominator?sre.MathspeakUtil.numberToWords(a.enumerator)+b+sre.MathspeakUtil.numberToOrdinal(a.denominator,1!==a.enumerator):a.content||""};sre.MathspeakUtil.vulgarFractionSmall=function(a,b,c){var d=sre.MathspeakUtil.convertVulgarFraction_(a);return d.convertible?(a=d.enumerator,d=d.denominator,0<a&&a<b&&0<d&&d<c):!1};
...
sre.MathspeakUtil.removeParens=function(a){if(!a.childNodes.length||!a.childNodes[0].childNodes.length||!a.childNodes[0].childNodes[0].childNodes.length)return"";a=a.childNodes[0].childNodes[0].childNodes[0].textContent;return a.match(/^\(.+\)$/)?a.slice(1,-1):a};sre.MathspeakUtil.componentString_={2:"CSFbaseline",1:"CSFsubscript",0:"CSFsuperscript"};sre.MathspeakUtil.childNumber_={4:2,3:3,2:1,1:4,0:5};
sre.MathspeakUtil.generateTensorRuleStrings_=function(a){var b=[],c="",d="";a=parseInt(a,2);for(var e=0;5>e;e++){var f="children/*["+sre.MathspeakUtil.childNumber_[e]+"]";if(a&1){var g=sre.MathspeakUtil.componentString_[e%3];c="[t] "+g+"Verbose; [n] "+f+";"+c;d="[t] "+g+"Brief; [n] "+f+";"+d}else b.unshift("name("+f+')="empty"');a>>=1}b.push(c);b.push(d);return b};
...
LEVEL:"Level"},REGEXP:{TEXT:"a-zA-Z",NUMBER:"((\\d{1,3})(?=(,| ))((,| )\\d{3})*(\\.\\d+)?)|^\\d*\\.\\d+|^\\d+",DECIMAL_MARK:".",DIGIT_GROUP:","},PLURAL_UNIT:{foot:"feet",inch:"inches"}};sre.Locale.es={MS:{START:"empezar ",FRAC_V:"fracci\u00f3n",FRAC_B:"frac",FRAC_S:"frac",END:"finalizar ",FRAC_OVER:"entre ",TWICE:"",NEST_FRAC:"",ENDFRAC:"",SUPER:"super",SUB:"sub",SUP:"sup",SUPERSCRIPT:"super\u00edndice",SUBSCRIPT:"sub\u00edndice",BASELINE:"l\u00ednea base",BASE:"",NESTED:"",NEST_ROOT:"",STARTROOT:"empezar ra\u00edz",ENDROOT:"finalizar ra\u00edz",ROOTINDEX:"\u00edndice de ra\u00edz",ROOT:"ra\u00edz",INDEX:"",UNDER:"bajo",UNDERSCRIPT:"bajo\u00edndice",OVER:"sobre",OVERSCRIPT:"sobre\u00edndice"},
...
sre.MathStore.prototype.evaluateString_=function(a){var b=[];if(a.match(/^\s+$/))return b;a=sre.BaseUtil.removeEmpty(a.replace(/\s/g," ").split(" "));for(var c=0,d;d=a[c];c++)if(1==d.length)b.push(this.evaluate_(d));else if(d.match(new RegExp("^["+sre.Messages.REGEXP.TEXT+"]+$")))b.push(this.evaluate_(d));else for(;d;){var e=this.matchNumber_(d),f=d.match(new RegExp("^["+sre.Messages.REGEXP.TEXT+"]+"));e?(b.push(this.evaluate_(e.number)),d=d.substring(e.length)):f?(b.push(this.evaluate_(f[0])),d=
d.substring(f[0].length)):(e=d[0].charCodeAt(0),55296<=e&&56319>=e&&1<d.length&&!isNaN(d.charCodeAt(1))?(b.push(this.evaluate_(d.slice(0,2))),d=d.substring(2)):(b.push(this.evaluate_(d[0])),d=d.substring(1)))}return b};
sre.MathStore.prototype.matchNumber_=function(a){var b=a.match(new RegExp("^"+sre.Messages.REGEXP.NUMBER));a=a.match(/^((\d{1,3})(?=(,| ))((,| )\d{3})*(\.\d+)?)|^\d*\.\d+|^\d+/);return b&&a?!a||b&&b[0].length>a[0].length?{number:b,length:b[0].length}:{number:a[0].replace(/,/g,"X").replace(/\./g,sre.Messages.REGEXP.DECIMAL_MARK).replace(/X/g,sre.Messages.REGEXP.DIGIT_GROUP),length:a[0].length}:null};
sre.MathStore.prototype.evaluate_=function(a){return sre.AuditoryDescription.create({text:a},{adjust:!0,translate:!0})};sre.WalkerUtil={};sre.WalkerUtil.splitAttribute=function(a){return a?a.split(/,/):[]};sre.WalkerUtil.getAttribute=function(a,b){return sre.DomUtil.getDataAttribute(a,b)};sre.WalkerUtil.getSemanticRoot=function(a){if(a.hasAttribute(sre.EnrichMathml.Attribute.TYPE)&&!a.hasAttribute(sre.EnrichMathml.Attribute.PARENT))return a;for(var b=sre.DomUtil.querySelectorAllByAttr(a,sre.EnrichMathml.Attribute.TYPE),c=0,d;d=b[c];c++)if(!d.hasAttribute(sre.EnrichMathml.Attribute.PARENT))return d;return a};
...
sre.RebuildStree.prototype.collapsedChildren_=function(a){var b=goog.bind(function(a){var c=this.nodeDict[a[0]];c.childNodes=[];for(var e=1,f=a.length;e<f;e++){var g=a[e];c.childNodes.push(sre.SemanticSkeleton.simpleCollapseStructure(g)?this.nodeDict[g]:b(g))}return c},this);b(a)};sre.SpeechGenerator=function(){};sre.SpeechGenerator.prototype.getSpeech=function(a,b){};sre.SpeechGenerator.prototype.getRebuilt=function(){};sre.SpeechGenerator.prototype.setRebuilt=function(a){};sre.SpeechGenerator.prototype.start=function(){};sre.SpeechGenerator.prototype.end=function(){};sre.MathSimpleStore=function(){sre.MathStore.call(this);this.category=""};goog.inherits(sre.MathSimpleStore,sre.MathStore);sre.MathSimpleStore.prototype.defineRulesFromMappings=function(a,b,c){for(var d in c)for(var e in c[d])this.defineRule(a,d+"."+e,'[t] "'+c[d][e]+'"',"self::text()",'"'===b?"self::text() = '"+b+"'":'self::text() = "'+b+'"')};
...
sre.AbstractionRules.initAbstractionRules_=function(){(0,sre.AbstractionRules.defineRule_)("abstr-collapsed","mathspeak.default",'[t] "collapsed"; [n] . (grammar:collapsed)',"self::*","@alternative",'not(@alternative="summary")','not(contains(@grammar, "collapsed"))',"self::*","self::*","self::*","self::*");(0,sre.AbstractionRules.defineRule_)("abstr-identifier","mathspeak.default",'[t] "long identifier"',"self::identifier","@alternative","self::*","self::*","self::*","self::*");(0,sre.AbstractionRules.defineRule_)("abstr-identifier",
"mathspeak.default",'[t] "identifier"',"self::identifier",'@alternative="summary"',"@alternative","self::*","self::*","self::*","self::*");(0,sre.AbstractionRules.defineRule_)("abstr-identifier","mathspeak.brief",'[t] "identifier"',"self::identifier","@alternative","self::*","self::*","self::*","self::*");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-identifier","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-number","mathspeak.default",'[t] "long number"',
"self::number","@alternative");(0,sre.AbstractionRules.defineRule_)("abstr-number","mathspeak.default",'[t] "number"',"self::number","@alternative",'@alternative="summary"');(0,sre.AbstractionRules.defineRule_)("abstr-number","mathspeak.brief",'[t] "number"',"self::number","@alternative");(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-number","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-mixed-number","mathspeak.default",'[t] "long mixed number"',"self::number",
"@alternative",'@role="mixed"');(0,sre.AbstractionRules.defineRule_)("abstr-mixed-number","mathspeak.brief",'[t] "mixed number"',"self::number","@alternative",'@role="mixed"');(0,sre.AbstractionRules.defineSpecialisedRule_)("abstr-mixed-number","mathspeak.brief","mathspeak.sbrief");(0,sre.AbstractionRules.defineRule_)("abstr-text","mathspeak.default",'[t] "text"',"self::text","@alternative");(0,sre.AbstractionRules.defineRule_)("abstr-function","mathspeak.default",'[t] "functional expression"',"self::function",
...
sre.ClearspeakUtil.ordinalExponent=function(a){var b=parseInt(a.textContent,10);return isNaN(b)?a.textContent:10<b?sre.MathspeakUtil.simpleOrdinal(b):sre.MathspeakUtil.wordOrdinal(b)};sre.ClearspeakUtil.isCapitalLetter=function(a){return"Lu"===sre.MathCompoundStore.getInstance().lookupCategory(a.textContent)?[a]:[]};sre.ClearspeakUtil.NESTING_DEPTH=null;
...
sre.ClearspeakRules.initClearspeakRules_=function(){(0,sre.ClearspeakRules.defineRule_)("stree","clearspeak.default","[n] ./*[1]","self::stree");(0,sre.ClearspeakRules.defineRule_)("unknown","clearspeak.default","[n] text()","self::unknown");(0,sre.ClearspeakRules.defineRule_)("protected","mathspeak.default","[t] text()","self::number",'contains(@grammar, "protected")');(0,sre.ClearspeakRules.defineRule_)("omit-empty","clearspeak.default",'[p] (pause:"short")',"self::empty");(0,sre.ClearspeakRules.defineRule_)("font",
"clearspeak.default",'[t] @font; [n] self::* (grammar:ignoreFont=@font,pause:"short")',"self::*","@font",'not(contains(@grammar, "ignoreFont"))','@font!="normal"');(0,sre.ClearspeakRules.defineRule_)("font-identifier","clearspeak.default",'[t] @font; [n] self::* (grammar:ignoreFont=@font,pause:"short")',"self::identifier","string-length(text())=1","@font",'@font="normal"','not(contains(@grammar, "ignoreFont"))','@role!="unit"');(0,sre.ClearspeakRules.defineRule_)("omit-font","clearspeak.default",
"[n] self::* (grammar:ignoreFont=@font)","self::identifier","string-length(text())=1","@font",'not(contains(@grammar, "ignoreFont"))','@font="italic"');(0,sre.ClearspeakRules.defineRule_)("german-font","clearspeak.default",'[t] "German"; [n] self::* (grammar:ignoreFont=@font)',"self::*","@font",'not(contains(@grammar, "ignoreFont"))','@font="fraktur"');(0,sre.ClearspeakRules.defineRule_)("german-font","clearspeak.default",'[t] "bold German"; [n] self::* (grammar:ignoreFont=@font)',"self::*","@font",
'not(contains(@grammar, "ignoreFont"))','@font="bold-fraktur"');(0,sre.ClearspeakRules.defineRule_)("text","clearspeak.default","[n] text()","self::text");(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.default",'[n] text() (pitch:0.6,grammar:ignoreFont="cap")',"self::identifier",'@role="latinletter" or @role="greekletter" or @role="simple function"',"CQFisCapital");(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.Caps_SayCaps","[n] text()","self::identifier",'@role="latinletter" or @role="greekletter"',
"CQFisCapital");(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.Caps_SayCaps",'[p] (pause:"short"); [n] text()',"self::identifier",'@role="latinletter" or @role="greekletter"',"CQFisCapital","preceding-sibling::*[1]",'not(name(preceding-sibling::*[1])="function")','not(contains(@grammar, "angle"))');(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.Caps_SayCaps",'[n] text() (pause:"short")',"self::identifier",'@role="latinletter" or @role="greekletter"',"CQFisCapital","following-sibling::*[1]");
(0,sre.ClearspeakRules.defineRule_)("capital","clearspeak.Caps_SayCaps",'[p] (pause:"short"); [n] text() (pause:"short")',"self::identifier",'@role="latinletter" or @role="greekletter"',"CQFisCapital","preceding-sibling::*[1]","following-sibling::*[1]",'not(name(preceding-sibling::*[1])="function")','not(contains(@grammar, "angle"))');(0,sre.ClearspeakRules.defineRule_)("punctuation-lr","clearspeak.default",'[p] (pause:"short"); [n] text() (pause:"short")',"self::punctuation",'@role="comma"');(0,sre.ClearspeakRules.defineRule_)("punctuation",
"clearspeak.default","[n] text()","self::punctuation",'@role="comma"',"not(preceding-sibling::*[1]/children)","not(following-sibling::*[1]/children)");(0,sre.ClearspeakRules.defineRule_)("punctuation-l","clearspeak.default",'[p] (pause:"short"); [n] text()',"self::punctuation",'@role="comma"',"not(following-sibling::*[1]/children)");(0,sre.ClearspeakRules.defineRule_)("punctuation-r","clearspeak.default",'[n] text() (pause:"short")',"self::punctuation",'@role="comma"',"not(preceding-sibling::*[1]/children)");
(0,sre.ClearspeakRules.defineRule_)("ellipsis","clearspeak.Ellipses_AndSoOn",'[t] "and so on"',"self::punctuation",'@role="ellipsis"',"not(following-sibling::*[1])",'not(preceding-sibling::*[last()][@role="ellipsis"])');(0,sre.ClearspeakRules.defineRule_)("ellipsis","clearspeak.Ellipses_AndSoOn",'[t] "and so on up to"',"self::punctuation",'@role="ellipsis"',"preceding-sibling::*[1]","following-sibling::*[1]");(0,sre.ClearspeakRules.defineRule_)("vbar-evaluated","clearspeak.default",'[n] children/*[1]; [p] (pause:"short"); [t] "evaluated at"; [n] content/*[1]/children/*[2]; [p] (pause:"short")',
"self::punctuated",'@role="endpunct"','content/*[1][@role="vbar"]',"content/*[1][@embellished]",'name(content/*[1])="subscript"');(0,sre.ClearspeakRules.defineRule_)("vbar-evaluated","clearspeak.default",'[n] children/*[1]; [p] (pause:"short"); [t] "evaluated at"; [n] content/*[1]/children/*[2]; [p] (pause:"short"); [t] "minus the same expression evaluated at"; [n] content/*[1]/children/*[1]/children/*[2]; [p] (pause:"short")',"self::punctuated",'@role="endpunct"','content/*[1][@role="vbar"]',"content/*[1][@embellished]",
'name(content/*[1])="superscript"','name(content/*[1]/children/*[1])="subscript"');(0,sre.ClearspeakRules.defineRule_)("vbar-such-that","clearspeak.VerticalLine_SuchThat",'[t] "such that"',"self::punctuation",'@role="vbar"','not(parent::*/parent::*[@embellished="punctuation"])');(0,sre.ClearspeakRules.defineRule_)("vbar-such-that","clearspeak.VerticalLine_Divides",'[t] "divides"',"self::punctuation",'@role="vbar"','not(parent::*/parent::*[@embellished="punctuation"])');(0,sre.ClearspeakRules.defineRule_)("vbar-such-that",
"clearspeak.VerticalLine_Given",'[t] "given"',"self::punctuation",'@role="vbar"','not(parent::*/parent::*[@embellished="punctuation"])');(0,sre.ClearspeakRules.defineRule_)("set-member","clearspeak.default",'[t] "in"',"self::operator",'@role="set extended"','text()="\u2208" or text()="\u220a"');(0,sre.ClearspeakRules.defineSpecialisedRule_)("set-member","clearspeak.default","clearspeak.SetMemberSymbol_Member",'[t] "member of"');(0,sre.ClearspeakRules.defineSpecialisedRule_)("set-member","clearspeak.default",
"clearspeak.SetMemberSymbol_Element",'[t] "element of"');(0,sre.ClearspeakRules.defineSpecialisedRule_)("set-member","clearspeak.default","clearspeak.SetMemberSymbol_Belongs",'[t] "belonging to"');(0,sre.ClearspeakRules.defineRule_)("set-not-member","clearspeak.default",'[t] "not in"',"self::operator",'@role="set extended"','text()="\u2209"');(0,sre.ClearspeakRules.defineSpecialisedRule_)("set-not-member","clearspeak.default","clearspeak.SetMemberSymbol_Member",'[t] "not member of"');(0,sre.ClearspeakRules.defineSpecialisedRule_)("set-not-member",
"clearspeak.default","clearspeak.SetMemberSymbol_Element",'[t] "not element of"');(0,sre.ClearspeakRules.defineSpecialisedRule_)("set-not-member","clearspeak.default","clearspeak.SetMemberSymbol_Belongs",'[t] "not belonging to"');(0,sre.ClearspeakRules.defineRule_)("prime","clearspeak.default","[n] children/*[1]; [n] children/*[2]","self::superscript","children/*[2]",'children/*[2][@role="prime"]',"self::*");(0,sre.ClearspeakRules.defineRule_)("feet","clearspeak.default",'[n] children/*[1]; [t] "feet"',
"self::superscript",'children/*[2][@role="prime"]','name(children/*[1])="number"','children/*[2][text()="\u2032"]','not(preceding-sibling::*[@role="degree"])');(0,sre.ClearspeakRules.defineRule_)("foot","clearspeak.default",'[n] children/*[1]; [t] "foot"',"self::superscript",'children/*[2][@role="prime"]','name(children/*[1])="number"','children/*[2][text()="\u2032"]','children/*[1][text()="1"]','not(preceding-sibling::*[@role="degree"])');(0,sre.ClearspeakRules.defineRule_)("inches","clearspeak.default",
'[n] children/*[1]; [t] "inches"',"self::superscript",'children/*[2][@role="prime"]','name(children/*[1])="number"','children/*[2][text()="\u2033"]','not(preceding-sibling::*[@role="degree"])');(0,sre.ClearspeakRules.defineRule_)("inch","clearspeak.default",'[n] children/*[1]; [t] "inch"',"self::superscript",'children/*[2][@role="prime"]','name(children/*[1])="number"','children/*[2][text()="\u2033"]','children/*[1][text()="1"]','not(preceding-sibling::*[@role="degree"])');(0,sre.ClearspeakRules.defineRule_)("minutes",
"clearspeak.default",'[p] (pause:short); [n] children/*[1]; [t] "minutes"',"self::superscript",'children/*[2][@role="prime"]','preceding-sibling::*[@role="degree"]','children/*[2][text()="\u2032"]');(0,sre.ClearspeakRules.defineRule_)("minute","clearspeak.default",'[p] (pause:short); [n] children/*[1]; [t] "minute"',"self::superscript",'children/*[2][@role="prime"]','preceding-sibling::*[@role="degree"]','children/*[2][text()="\u2032"]','children/*[1][text()="1"]');(0,sre.ClearspeakRules.defineRule_)("seconds",
"clearspeak.default",'[p] (pause:short); [n] children/*[1]; [t] "seconds"',"self::superscript",'children/*[2][@role="prime"]','preceding-sibling::*[@role="degree"]','children/*[2][text()="\u2033"]');(0,sre.ClearspeakRules.defineRule_)("second","clearspeak.default",'[p] (pause:short); [n] children/*[1]; [t] "second"',"self::superscript",'children/*[2][@role="prime"]','preceding-sibling::*[@role="degree"]','children/*[2][text()="\u2033"]','children/*[1][text()="1"]');(0,sre.ClearspeakRules.defineRule_)("degrees-angle",
"clearspeak.Prime_Angle",'[n] children/*[1]; [t] "degrees"; [p] (pause:short)',"self::punctuation",'@role="degree"');(0,sre.ClearspeakRules.defineRule_)("degree-angle","clearspeak.Prime_Angle",'[n] children/*[1]; [t] "degree"; [p] (pause:short)',"self::punctuation",'@role="degree"','children/*[1][text()="1"]');(0,sre.ClearspeakRules.defineRule_)("minutes-angle","clearspeak.Prime_Angle",'[n] children/*[1]; [t] "minutes"; [p] (pause:short)',"self::superscript",'children/*[2][@role="prime"]','name(children/*[1])="number" or (children/*[1][@role="latinletter"] and ""=translate(children/*[1]/text(),"abcdefghijklmnopqrstuvwxyz", ""))',
'children/*[2][text()="\u2032"]');(0,sre.ClearspeakRules.defineRule_)("minute-angle","clearspeak.Prime_Angle",'[n] children/*[1]; [t] "minute"; [p] (pause:short)',"self::superscript",'children/*[2][@role="prime"]','children/*[2][text()="\u2032"]','children/*[1][text()="1"]');(0,sre.ClearspeakRules.defineRule_)("seconds-angle","clearspeak.Prime_Angle",'[n] children/*[1]; [t] "seconds"; [p] (pause:short)',"self::superscript",'children/*[2][@role="prime"]','name(children/*[1])="number" or (children/*[1][@role="latinletter"] and ""=translate(children/*[1]/text(),"abcdefghijklmnopqrstuvwxyz", ""))',
...
"clearspeak.default",'[n] children/*[1]; [t] "from"; [n] children/*[2]',"self::underscore",'@role="underover"','children/*[2][@role!="underaccent"]');(0,sre.ClearspeakRules.defineRule_)("number","clearspeak.default","[n] text()","self::number");(0,sre.ClearspeakRules.defineRule_)("mixed-number","clearspeak.default",'[n] children/*[1]; [t] "and"; [n] children/*[2]; ',"self::number",'@role="mixed"');(0,sre.ClearspeakRules.defineRule_)("number-with-chars","clearspeak.default",'[t] "number"; [m] CQFspaceoutNumber (grammar:protected)',
"self::number",'@role="othernumber"','"" != translate(text(), "0123456789.,", "")','not(contains(@grammar, "protected"))');(0,sre.ClearspeakRules.defineRule_)("decimal-period","clearspeak.default",'[t] "the repeating decimal"; [n] children/*[1] (grammar:spaceout); [t] "point followed by repeating digits";  [n] children/*[3]/children/*[1] (grammar:spaceout)',"self::punctuated",'@role="sequence"',"count(./content/*)=1",'./content/*[1][@role="fullstop"]','name(children/*[1])="number"','children/*[1][@role="integer"]',
'name(children/*[3])="overscore"','children/*[3][@role="integer"]','children/*[3]/children/*[2][@role="overaccent"]','children/*[3]/children/*[2][text()="\u00af" or text()="\uffe3" or text()="\uff3f" or text()="_" or text()="\u203e"]');(0,sre.ClearspeakRules.defineRule_)("decimal-period","clearspeak.default",'[t] "the repeating decimal"; [n] children/*[1] (grammar:spaceout); [t] "followed by repeating digits";  [n] children/*[2]/children/*[1] (grammar:spaceout);',"self::infixop",'@role="implicit"',
"count(./children/*)=2",'name(children/*[1])="number"','children/*[1][@role="float"]','name(children/*[2])="overscore"','children/*[2][@role="integer"]','children/*[2]/children/*[2][@role="overaccent"]','children/*[2]/children/*[2][text()="\u00af" or text()="\uffe3" or text()="\uff3f" or text()="_" or text()="\u203e"]');(0,sre.ClearspeakRules.defineRule_)("decimal-period-singular","clearspeak.default",'[t] "the repeating decimal"; [n] children/*[1] (grammar:spaceout); [t] "point followed by repeating digit";  [n] children/*[3]/children/*[1] (grammar:spaceout)',
...
'@role="mixed"');(0,sre.MathspeakRules.defineRule_)("number-with-chars","mathspeak.default",'[t] "Number"; [m] CQFspaceoutNumber (grammar:protected)',"self::number",'@role="othernumber"','"" != translate(text(), "0123456789.,", "")','not(contains(@grammar, "protected"))');(0,sre.MathspeakRules.defineSpecialisedRule_)("number-with-chars","mathspeak.default","mathspeak.brief",'[t] "Num"; [m] CQFspaceoutNumber (grammar:protected)');(0,sre.MathspeakRules.defineSpecialisedRule_)("number-with-chars","mathspeak.brief",
"mathspeak.sbrief");(0,sre.MathspeakRules.defineRule_)("number-as-upper-word","mathspeak.default",'[t] "UpperWord"; [t] CSFspaceoutText',"self::number","string-length(text())>1",'text()=translate(text(), "abcdefghijklmnopqrstuvwxyz\u03b1\u03b2\u03b3\u03b4\u03b5\u03b6\u03b7\u03b8\u03b9\u03ba\u03bb\u03bc\u03bd\u03be\u03bf\u03c0\u03c1\u03c2\u03c3\u03c4\u03c5\u03c6\u03c7\u03c8\u03c9", "ABCDEFGHIJKLMNOPQRSTUVWXYZ\u0391\u0392\u0393\u0394\u0395\u0396\u0397\u0398\u0399\u039a\u039b\u039c\u039d\u039e\u039f\u03a0\u03a1\u03a3\u03a3\u03a4\u03a5\u03a6\u03a7\u03a8\u03a9")',
...
sre.MathspeakSpanishUtil.unitMultipliers);(0,sre.MathspeakSpanish.addCustomQuery_)("CQFdetIsSimple",sre.MathspeakUtil.determinantIsSimple);(0,sre.MathspeakSpanish.addCustomString_)("CSFRemoveParens",sre.MathspeakUtil.removeParens);(0,sre.MathspeakSpanish.addCustomQuery_)("CQFoneLeft",sre.MathspeakSpanishUtil.oneLeft);(0,sre.MathspeakSpanish.addCustomQuery_)("CQFresetNesting",sre.MathspeakUtil.resetNestingDepth)};
sre.MathspeakSpanish.initMathspeakSpanish_=function(){(0,sre.MathspeakSpanish.defineRule_)("stree","mathspeak.default","[n] ./*[1]","self::stree","CQFresetNesting");(0,sre.MathspeakSpanish.defineRule_)("unknown","mathspeak.default","[n] text()","self::unknown");(0,sre.MathspeakSpanish.defineRule_)("protected","mathspeak.default","[t] text()","self::number",'contains(@grammar, "protected")');(0,sre.MathspeakSpanish.defineRule_)("omit-empty","mathspeak.default","[p] (pause:100)","self::empty");(0,sre.MathspeakSpanish.defineRule_)("blank-empty",
...
"mathspeak.default","[t] @font (grammar:localFont); [n] . (grammar:ignoreFont=@font)","self::identifier","string-length(text())=1","@font",'@font="normal"','not(contains(@grammar, "ignoreFont"))','@role!="unit"');(0,sre.MathspeakSpanish.defineRule_)("omit-font","mathspeak.default","[n] . (grammar:ignoreFont=@font)","self::identifier","string-length(text())=1","@font",'not(contains(@grammar, "ignoreFont"))','@font="italic"');(0,sre.MathspeakSpanish.defineRule_)("number","mathspeak.default","[n] text()",
"self::number");(0,sre.MathspeakSpanish.defineRule_)("mixed-number","mathspeak.default",'[n] children/*[1]; [t] "m\u00e1s"; [n] children/*[2]; ',"self::number",'@role="mixed"');(0,sre.MathspeakSpanish.defineRule_)("number-with-chars","mathspeak.default",'[t] "n\u00famero"; [m] CQFspaceoutNumber (grammar:protected)',"self::number",'@role="othernumber"','"" != translate(text(), "0123456789.,", "")','not(contains(@grammar, "protected"))');(0,sre.MathspeakSpanish.defineSpecialisedRule_)("number-with-chars",
"mathspeak.default","mathspeak.brief",'[t] "n\u00fam"; [m] CQFspaceoutNumber (grammar:protected)');(0,sre.MathspeakSpanish.defineSpecialisedRule_)("number-with-chars","mathspeak.brief","mathspeak.sbrief");(0,sre.MathspeakSpanish.defineRule_)("number-as-upper-word","mathspeak.default",'[t] "may\u00fascula"; [t] CSFspaceoutText',"self::number","string-length(text())>1",'text()=translate(text(), "abcdefghijklmnopqrstuvwxyz\u03b1\u03b2\u03b3\u03b4\u03b5\u03b6\u03b7\u03b8\u03b9\u03ba\u03bb\u03bc\u03bd\u03be\u03bf\u03c0\u03c1\u03c2\u03c3\u03c4\u03c5\u03c6\u03c7\u03c8\u03c9", "ABCDEFGHIJKLMNOPQRSTUVWXYZ\u0391\u0392\u0393\u0394\u0395\u0396\u0397\u0398\u0399\u039a\u039b\u039c\u039d\u039e\u039f\u03a0\u03a1\u03a3\u03a3\u03a4\u03a5\u03a6\u03a7\u03a8\u03a9")',
...
"mathspeak.default","mathspeak.brief",'[t] "base"; [t] @font; [n] . (grammar:ignoreFont=@font)');(0,sre.MathspeakSpanish.defineSpecialisedRule_)("number-baseline-font","mathspeak.brief","mathspeak.sbrief");(0,sre.MathspeakSpanish.defineRule_)("identifier","mathspeak.default","[m] CQFspaceoutIdentifier","self::identifier","string-length(text())>1",'@role!="unit"','not(@font) or @font="normal" or contains(@grammar, "ignoreFont")','text()!=translate(text(), "abcdefghijklmnopqrstuvwxyz\u03b1\u03b2\u03b3\u03b4\u03b5\u03b6\u03b7\u03b8\u03b9\u03ba\u03bb\u03bc\u03bd\u03be\u03bf\u03c0\u03c1\u03c2\u03c3\u03c4\u03c5\u03c6\u03c7\u03c8\u03c9ABCDEFGHIJKLMNOPQRSTUVWXYZ\u0391\u0392\u0393\u0394\u0395\u0396\u0397\u0398\u0399\u039a\u039b\u039c\u039d\u039e\u039f\u03a0\u03a1\u03a3\u03a3\u03a4\u03a5\u03a6\u03a7\u03a8\u03a9", "")');
...
sre.SpeechRuleEngine.prototype.evaluateTree_=function(a){sre.Debugger.getInstance().output(a.toString());var b=sre.Engine.getInstance();if(b.cache){var c=this.getCacheForNode_(a);if(c)return a.attributes&&this.addPersonality_(c,{},!1,a),c}sre.Grammar.getInstance().setAttribute(a);var d=this.activeStore_.lookupRule(a,b.dynamicCstr);if(!d){if(b.strict)return[];c=this.activeStore_.evaluateDefault(a);a.attributes&&this.addPersonality_(c,{},!1,a);this.pushCache_(a,c);return c}sre.Debugger.getInstance().generateOutput(goog.bind(function(){return[d.name,
d.dynamicCstr.toString(),a.toString()]},this));b=d.action.components;c=[];for(var e=0,f;f=b[e];e++){var g=[],h=f.content||"",k=f.attributes||{},l=!1;f.grammar&&this.processGrammar(a,f.grammar);switch(f.type){case sre.SpeechRule.Type.NODE:(h=this.activeStore_.applyQuery(a,h))&&(g=this.evaluateTree_(h));break;case sre.SpeechRule.Type.MULTI:l=!0;h=this.activeStore_.applySelector(a,h);0<h.length&&(g=this.evaluateNodeList_(h,k.sepFunc,this.constructString(a,k.separator),k.ctxtFunc,this.constructString(a,
k.context)));break;case sre.SpeechRule.Type.TEXT:(h=this.constructString(a,h))&&(g=[sre.AuditoryDescription.create({text:h},{adjust:!0})]);break;default:g=[sre.AuditoryDescription.create({text:h})]}g[0]&&!l&&(k.context&&(g[0].context=this.constructString(a,k.context)+(g[0].context||"")),k.annotation&&(g[0].annotation=k.annotation));f.grammar&&sre.Grammar.getInstance().popState();c=c.concat(this.addPersonality_(g,k,l,a))}this.pushCache_(a,c);return c};
...
[g?d[1]:f];d=a.getOrder();for(e=0;f=d[e];e++)if(!c[f]){g=a.getValue(f);var h=this.makeSet_(g,a.preference),k=sre.DynamicCstr.DEFAULT_VALUES[f];b||g===k||h.push(k);c[f]=h}a.updateProperties(c)};sre.SpeechRuleEngine.prototype.makeSet_=function(a,b){return b&&Object.keys(b).length?a.split(":"):[a]};sre.SpeechRuleEngine.prototype.enumerate=function(){return this.enumerate_(this.activeStore_.trie.root)};
sre.SpeechRuleEngine.prototype.enumerate_=function(a){var b={};a=a.getChildren();for(var c=0,d;d=a[c];c++)d.kind===sre.TrieNode.Kind.DYNAMIC&&(b[d.getConstraint()]=this.enumerate_(d));return b};sre.SpeechGeneratorUtil={};sre.SpeechGeneratorUtil.computeSpeech=function(a){var b=sre.SpeechRuleEngine.getInstance();b.clearCache();return b.evaluateNode(a)};sre.SpeechGeneratorUtil.recomputeSpeech=function(a){a=sre.SemanticTree.fromNode(a);return sre.SpeechRuleEngine.getInstance().evaluateNode(a.xml())};
...
sre.AbstractWalker.prototype.mergePrefix_=function(a,b){b=b||[];var c=this.prefix_(),d=sre.AuralRendering.getInstance();c&&a.unshift(c);return d.finalize(d.merge(b.concat(a)))};sre.AbstractWalker.prototype.prefix_=function(){var a=this.focus_.getDomNodes(),b=this.focus_.getSemanticNodes();return a[0]?sre.WalkerUtil.getAttribute(a[0],sre.EnrichMathml.Attribute.PREFIX):sre.SpeechGeneratorUtil.retrievePrefix(b[0])};
...
sre.System.prototype.setupEngine=function(a){var b=sre.Engine.getInstance(),c=function(c){b[c]=a[c]||b[c]};c("mode");sre.System.prototype.configBlocks_(a);["strict","cache","semantics","structure"].forEach(function(c){"undefined"!==typeof a[c]&&(b[c]=!!a[c])});"markup style domain speech walker locale rate".split(" ").forEach(c);a.json&&(sre.SystemExternal.jsonPath=sre.BaseUtil.makePath(a.json));a.xpath&&(sre.SystemExternal.WGXpath=a.xpath);b.setupBrowsers();b.ruleSets=a.rules?a.rules:sre.SpeechRuleStores.availableSets();
...
sre.System.prototype.fileToDescription=function(a,b){sre.System.getInstance().processFile_(function(a){return JSON.stringify(sre.System.getInstance().toDescription(a))},a,b)};sre.System.prototype.fileToEnriched=function(a,b){sre.System.getInstance().processFile_(function(a){return sre.System.getInstance().toEnriched(a).toString()},a,b)};sre.System.prototype.processXml=function(a){a=sre.SpeechGeneratorUtil.computeSpeech(a);var b=sre.AuralRendering.getInstance();return b.finalize(b.markup(a))};
sre.System.prototype.parseExpression_=function(a,b){var c=null;try{c=sre.DomUtil.parseInput(a,sre.System.Error),b&&(c=sre.System.getInstance().getSemanticTree(c)),sre.Debugger.getInstance().generateOutput(goog.bind(function(){return c.toString()},this))}catch(d){console.error("Parse Error: "+d.message)}return c};sre.System.prototype.getSemanticTree=function(a){return sre.Semantic.xmlTree(a)};
...
sre.System.prototype.processFileAsync_=function(a,b,c){sre.System.getInstance().inputFileAsync_(b,goog.bind(function(b){b=a(b);c?sre.SystemExternal.fs.writeFile(c,b,function(a){if(a)throw new sre.System.Error("Can not write to file: "+c);}):console.info(b)},this))};
...
sre.Cli.prototype.runProcessors_=function(a,b){try{this.processors.length||this.processors.push("Speech"),b&&this.processors.forEach(function(c){a(c,b)})}catch(c){console.info(c.name+": "+c.message),sre.Debugger.getInstance().exit(function(){sre.SystemExternal.process.exit(1)})}};
...
"Locale [code].",c,"locale").option("-s, --semantics","Switch OFF semantics interpretation.",c,"semantics").option("-k, --markup [name]","Generate speech output with markup tags.",c,"markup").option("-r, --rate [value]","Base rate [value] for tagged speech output.",c,"rate").option("").option("-p, --speech","Generate speech output (default).",d,"Speech").option("-a, --audit","Generate auditory descriptions (JSON format).",d,"Description").option("-j, --json","Generate JSON of semantic tree.",d,"Json").option("-x, --xml",
"Generate XML of semantic tree.",d,"Semantic").option("").option("-m, --mathml","Generate enriched MathML.",d,"Enriched").option("-g, --generate <depth>","Include generated speech in enriched MathML (with -m option only).",c,"speech").option("-r, --structure","Include structure attribute in enriched MathML (with -m option only).",c,"structure").option("").option("-v, --verbose","Verbose mode.").option("-l, --log [name]","Log file [name].").on("--help",goog.bind(this.enumerate,this)).parse(sre.SystemExternal.process.argv);
this.system.setupEngine(this.setup);a.verbose&&sre.Debugger.getInstance().init(a.log);a.input&&this.execute(a.input);a.args.length?a.args.forEach(goog.bind(this.execute,this)):this.readline();sre.Debugger.getInstance().exit(function(){sre.SystemExternal.process.exit(0)})};sre.SystemExternal.process&&sre.SystemExternal.process.env.SRE_TOP_PATH&&(new sre.Cli).commandLine();
